...
import { Accordion, AccordionSummary, AccordionDetails, Box, Typography, CircularProgress, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper } from '@mui/material';
import { CardGiftcard as GiftIcon, ExpandMore as ExpandMoreIcon } from '@mui/icons-material';
...
const EventGiftDashboard = ({ eventId, event, inventory = [], loading = false, error = '', onInventoryChange }) => {
  ...
  export default EventGiftDashboard;