...
const CSVColumnMapper = ({
    ...
    const inventoryFields = {
        ...
        optional: [
            ...
            { key: 'qtyBeforeEvent', label: 'Qty Before Event', description: 'Quantity brought to event' },
            { key: 'qtyOnSite', label: 'Qty On Site', description: 'Alternative to Qty Before Event' },
            { key: 'postEventCount', label: 'Post Event Count', description: 'Count after event' },
            { key: 'currentInventory', label: 'Current Inventory', description: 'Current available inventory' }
        ]
    };
        ...
        try {
            ...
            headers.forEach(header => {
                ...
                const matches = {
                    ...
                    'qtyBeforeEvent': ['qtybeforeevent', 'beforeevent', 'qtyonsite', 'onsite', 'onsiteqty'],
                    'qtyOnSite': ['qtyonsite', 'onsite', 'onsiteqty', 'qtybeforeevent'],
                    'postEventCount': ['posteventcount', 'postevent', 'remaining', 'finalcount'],
                    'currentInventory': ['currentinventory', 'current', 'available', 'availableqty']
                };
